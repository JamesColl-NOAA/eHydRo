...
elevatr_wrapper_for_tile = function(survey_location, TILE_ID) {
...
elevatr_wrapper_for_tile('G:/Dropbox/root/projects/GID_Inland_Hydrofabric/eHydRo/survey_2021_11_01',86647)
# breaks: 79647
...
aggregate_eHydro_footprints_within_AOI <- function(survey_location, AOI or TILE_ID,tile_feature_subset = NULL) {
